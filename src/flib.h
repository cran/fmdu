...
extern int gethashmapint( const size_t mapsize, hashmap* map, char32 key, const int defint );
extern size_t gethashmapsize_t( const size_t mapsize, hashmap* map, char32 key, const size_t defsize_t );
